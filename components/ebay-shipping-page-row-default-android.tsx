...
/**
 * RoW-Shelby-Default-Android Prototype
 * eBay Shipping Configuration Flow - Default Services View (Android)
 * 
 * Android adaptation of the iOS RoW-Shelby-Default prototype.
 * Key Android-specific differences:
 * - Android device frame (no Dynamic Island, rounded corners)
 * - Android status bar with different icon styles
 * - Android 3-button navigation bar at bottom
 * - Same features and functionality as iOS version
 */
...
export function EbayShippingPageRoWDefaultAndroid() {
  // L1 State
...
return (
    <div className="flex items-center justify-center">
      ...
      <div className="relative w-[402px] h-[874px] bg-[#1a1a1a] rounded-[32px] p-2 shadow-2xl">
        {/* Camera Punch Hole */}
        <div className="absolute top-[18px] left-1/2 -translate-x-1/2 w-[12px] h-[12px] bg-[#0a0a0a] rounded-full z-50" />
        
        {/* Screen */}
        <div className="relative w-full h-full bg-white rounded-[28px] overflow-hidden flex flex-col">
          {/* Android Status Bar */}
          <div className="h-[32px] px-5 flex items-center justify-between bg-white flex-shrink-0">
            <span className="text-[14px] font-medium text-[#191919]" style={{ fontFamily: "'Roboto', system-ui, sans-serif" }}>12:30</span>
            <div className="flex items-center gap-[6px]">
              {/* Mobile Signal */}
              <svg className="w-[16px] h-[14px]" viewBox="0 0 16 14" fill="none">
                <path d="M1 10H3V14H1V10Z" fill="#191919"/>
                <path d="M5 7H7V14H5V7Z" fill="#191919"/>
                <path d="M9 4H11V14H9V4Z" fill="#191919"/>
                <path d="M13 0H15V14H13V0Z" fill="#191919"/>
              </svg>
              {/* WiFi */}
              <svg className="w-[16px] h-[12px]" viewBox="0 0 16 12" fill="none">
                <path d="M8 9.5C8.83 9.5 9.5 10.17 9.5 11C9.5 11.83 8.83 12.5 8 12.5C7.17 12.5 6.5 11.83 6.5 11C6.5 10.17 7.17 9.5 8 9.5Z" fill="#191919"/>
                <path d="M4.5 7.5C5.5 6.5 6.67 6 8 6C9.33 6 10.5 6.5 11.5 7.5" stroke="#191919" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                <path d="M2 4.5C3.5 3 5.5 2 8 2C10.5 2 12.5 3 14 4.5" stroke="#191919" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
              </svg>
              {/* Battery */}
              <svg className="w-[22px] h-[11px]" viewBox="0 0 22 11" fill="none">
                <rect x="0.5" y="0.5" width="18" height="10" rx="2" stroke="#191919" strokeOpacity="0.4"/>
                <rect x="2" y="2" width="15" height="7" rx="1" fill="#191919"/>
                <path d="M20 3.5V7.5C20.8 7.5 21 6.5 21 5.5C21 4.5 20.8 3.5 20 3.5Z" fill="#191919" fillOpacity="0.4"/>
              </svg>
            </div>
          </div>
                    ...
                    >
                      <div className="flex gap-3 items-start">
                        ...
                        <div className="w-[52px] h-[52px] bg-[#F7F7F7] rounded-[8px] flex items-center justify-center flex-shrink-0 overflow-hidden">
                          {service.logoType === "usps" && <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-cWH5lVeaPsOCVI98OwMcLvRv4OOtHc.png" alt="USPS" className="w-full h-full object-contain p-1" />}
                          {service.logoType === "fedex" && <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-byPfnlbkfOvWXs44Z0CYw3xwKenhW0.png" alt="FedEx" className="w-[40px] h-auto object-contain" />}
...
{/* Recommended Badge */}
              ...
              <div>
                ...
                {selectedAdditionalDomestic && getSelectedAdditionalService() && (
                  ...
                  >
                    <div className="flex gap-3 items-start">
                      <div className="w-[52px] h-[52px] bg-[#F7F7F7] rounded-[8px] flex items-center justify-center flex-shrink-0 overflow-hidden">
                        {getSelectedAdditionalService()?.logoType === "usps" && <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-cWH5lVeaPsOCVI98OwMcLvRv4OOtHc.png" alt="USPS" className="w-full h-full object-contain p-1" />}
                        {getSelectedAdditionalService()?.logoType === "fedex" && <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-byPfnlbkfOvWXs44Z0CYw3xwKenhW0.png" alt="FedEx" className="w-[40px] h-auto object-contain" />}
            ...
            <div className="py-5">
              ...
              {selectedInternational && getSelectedInternationalService() && (
                ...
                >
                  <div className="flex gap-3 items-start">
                    <div className="w-[52px] h-[52px] bg-[#F7F7F7] rounded-[8px] flex items-center justify-center flex-shrink-0 overflow-hidden">
                      {getSelectedInternationalService()?.logoType === "usps" && <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-cWH5lVeaPsOCVI98OwMcLvRv4OOtHc.png" alt="USPS" className="w-full h-full object-contain p-1" />}
                      {getSelectedInternationalService()?.logoType === "fedex" && <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-byPfnlbkfOvWXs44Z0CYw3xwKenhW0.png" alt="FedEx" className="w-[40px] h-auto object-contain" />}
          ...
          {/* Fixed Bottom Button */}
          <div className="absolute bottom-[40px] left-0 right-0 px-4 pb-4 pt-3 bg-white">
            <button className="w-full h-[50px] bg-[#3665F3] rounded-full flex items-center justify-center active:bg-[#2d54d4]">
              <span className="text-[16px] font-bold text-white" style={{ fontFamily: "'Roboto', system-ui, sans-serif" }}>Continue</span>
            </button>
          </div>

          {/* Android Navigation Bar */}
          <div className="absolute bottom-0 left-0 right-0 h-[40px] bg-white flex items-center justify-center gap-16">
            <svg className="w-[20px] h-[20px]" viewBox="0 0 24 24" fill="none">
              <path d="M19 12H5M12 19l-7-7 7-7" stroke="#191919" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="10" stroke="#191919" strokeWidth="2"/>
            </svg>
            <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="none">
              <rect x="4" y="4" width="16" height="16" rx="2" stroke="#191919" strokeWidth="2"/>
            </svg>
          </div>
        </div>
      </div>
